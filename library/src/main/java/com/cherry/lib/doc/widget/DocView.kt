...
class DocView : FrameLayout,OnDownloadListener, OnWebLoadListener,OnPdfItemClickListener {
    ...
    lateinit var binding: DocViewBinding
    ...
    fun openDoc(activity: Activity?, docUrl: String?,
        ...
        Log.e("DocViewerActivity", "DocView initData-docUrl = $docUrl")
        ...
        if (docUrl != null && docSourceType == DocSourceType.URI && fileType == -1) {
            ...
            Log.e("DocViewerActivity", "DocView docUrl != null = $docUrl")
        ...
        Log.e("DocViewerActivity", "DocView 222 $docUrl")
        ...
        if (docSourceType == DocSourceType.PATH) {
            ...
            Log.e("DocViewerActivity", "DocView docSourceType == DocSourceType.PATH $docUrl")
        } else {
            sourceFilePath = null
        }
