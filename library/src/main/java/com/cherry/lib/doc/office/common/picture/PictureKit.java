...
import com.cherry.lib.doc.office.common.pictureefftect.PictureCroppedInfo;
import com.cherry.lib.doc.office.common.pictureefftect.PictureEffectInfo;
import com.cherry.lib.doc.office.common.pictureefftect.PictureEffectUtil;
...
public class PictureKit {
    ...
    /**
     * @param canvas     画布
     * @param path       byte数组的图片数据
     * @param options     数组的开始位置
     * @param effectInfor        长度
     * @param x          x值
     * @param y          y值
     * @param zoom       是否缩放
     * @param destWidth  如果缩放，指定缩放后的宽度
