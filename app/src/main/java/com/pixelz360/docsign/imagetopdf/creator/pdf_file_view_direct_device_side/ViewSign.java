...
public class ViewSign extends RelativeLayout {
    ...
    public ViewSign(Context context, int i, int i2) {
        super(context);
        this.mX = 0.0f;
        this.mY = 0.0f;
    ...
    public ViewSign(Context context, AttributeSet attributeSet, int i) {
...
//        mScaleDetector.onTouchEvent(motionEvent);
    ...
    public void enableToolBarButton() {
        if (getContext() != null) {
            try {
                ((ActivityFHand) getContext()).enableClear(true);
                ((ActivityFHand) getContext()).enableSave(true);
            }catch (Exception e){
