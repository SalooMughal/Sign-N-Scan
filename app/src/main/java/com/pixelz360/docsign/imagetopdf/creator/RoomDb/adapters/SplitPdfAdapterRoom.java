...
public class SplitPdfAdapterRoom extends RecyclerView.Adapter<SplitPdfAdapterRoom.ViewHolder> {
    ...
    public SplitPdfAdapterRoom(List<PdfFile> pdfFileList, Context context, RvListenerPdfRoom rvListenerPdf) {
