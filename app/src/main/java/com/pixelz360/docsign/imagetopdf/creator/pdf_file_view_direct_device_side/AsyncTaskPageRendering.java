...
public class AsyncTaskPageRendering extends AsyncTask<Void, Void, Bitmap>  {
    ...
    public interface OnPostExecuteListener {
        void onPostExecute(AsyncTaskPageRendering fASRenderPageAsyncTask, Bitmap bitmap);
    }

    AsyncTaskPageRendering(Context context, Page fASPage, SizeF sizeF, float f, boolean z, boolean z2, OnPostExecuteListener onPostExecuteListener) {
