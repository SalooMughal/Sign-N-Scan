...
public class LayoutSign extends RelativeLayout {
    ...
    Handler mRequestLayoutHandler = new Handler() {
        public void handleMessage(Message message) {
            if (message.what == 1) {
                LayoutSign.this.resizeDrawingView();
            }
    ...
    public LayoutSign(Context context) {
        super(context);
    }

    public LayoutSign(Context context, AttributeSet attributeSet) {
        super(context, attributeSet);
    }

    public LayoutSign(Context context, AttributeSet attributeSet, int i) {
