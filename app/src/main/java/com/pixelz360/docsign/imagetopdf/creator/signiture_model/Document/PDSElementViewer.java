...
import com.pixelz360.docsign.imagetopdf.creator.signiture_model.PDSModel.PDSElement;
    ...
    public void showBorder() {
        ...
        gradientDrawable.setStroke(2, this.mContext.getResources().getColor(R.color.black));
    ...
    public void changeColor(boolean z) {
        int color = z ? this.mContext.getResources().getColor(R.color.black) : ViewCompat.MEASURED_STATE_MASK;
        if (this.mElementView instanceof SignatureView) {
