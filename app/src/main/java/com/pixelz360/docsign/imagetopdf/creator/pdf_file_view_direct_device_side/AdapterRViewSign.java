...
public class AdapterRViewSign extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AdapterRViewSign(Context context, List<File> items) {
        this.items = items;
        ctx = context;
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, @SuppressLint("RecyclerView") final int position) {
        ...
        Log.d("PdfViewActivity11", "AdapterRViewSign getPath"+obj.getPath());
...
//            view.image.setImageResource(R.drawable.ic_text_to_pdf_icon);
        }
    }
