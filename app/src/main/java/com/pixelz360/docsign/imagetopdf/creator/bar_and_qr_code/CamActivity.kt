...
import com.pixelz360.docsign.imagetopdf.creator.databinding.ActivityCamBinding
...
//        binding.lblTitle.text = intent.extras?.getString("title")
        binding.lblTitle.text = resources.getString(R.string.app_name)
        ...
        firebaseAnalytics(this@CamActivity,"QR-AND-BAR-CODE-CamAndActivity")
                    ...
                    .also {
                        it.setAnalyzer(cameraExecutor, BarcodeAnalyzer { barcode ->
                            if (processingBarcode.compareAndSet(false, true)) {
                                beep()
                                Log.d("dd122wee", "Result: $barcode")

                                val intent = Intent(this@CamActivity,ResultCodeActivity::class.java)
