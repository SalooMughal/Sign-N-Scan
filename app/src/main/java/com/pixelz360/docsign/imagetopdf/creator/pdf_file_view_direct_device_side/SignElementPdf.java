...
public class SignElementPdf {
    ...
    public ViewElement mElementViewer;
    ...
    public SignElementPdf(PDSElementType fASElementType, File file) {
        this.mType = fASElementType;
        mfile = file;
    }

    public SignElementPdf(PDSElementType fASElementType, Bitmap file) {
        this.mType = fASElementType;
        bitmap = file;
    }
