...
public class StickerView extends FrameLayout {
    ...
    public StickerView(Context context, AttributeSet attributeSet, int defStyleAttr) {
        ...
        try {
            ...
            configDefaultIcons();  // Call to set default icons
        } finally {
            if (typedArray != null) {
                typedArray.recycle();
            }
    ...
    public void configDefaultIcons() {
        BitmapStickerIcon deleteIcon = new BitmapStickerIcon(
                resizeDrawable(ContextCompat.getDrawable(getContext(), R.drawable.sticker_ic_close_white_18dp), 50, 50),
                BitmapStickerIcon.LEFT_TOP);
        deleteIcon.setIconEvent(new DeleteIconEvent());

        BitmapStickerIcon zoomIcon = new BitmapStickerIcon(
                resizeDrawable(ContextCompat.getDrawable(getContext(), R.drawable.sticker_ic_scale_white_18dp), 50, 50),
                BitmapStickerIcon.RIGHT_BOTOM);
        zoomIcon.setIconEvent(new ZoomIconEvent());

        BitmapStickerIcon flipIcon = new BitmapStickerIcon(
                resizeDrawable(ContextCompat.getDrawable(getContext(), R.drawable.sticker_ic_flip_white_18dp), 50, 50),
